...
class NlpClient(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle('NLP内容生成器_20210128')
        ...
        people_info_grid.addWidget(self.domicile_qcb, 3, 3, 1, 1)
        people_info_grid.addWidget(self.residence_qcb, 3, 4, 1, 1)
        people_info_grid.addWidget(self.qq_qcb, 4, 1, 1, 1)
        people_info_grid.addWidget(self.wechat_qcb, 4, 2, 1, 1)
        people_info_grid.addWidget(self.twitter_qcb, 4, 3, 1, 1)
        people_info_grid.addWidget(self.bank_card_qcb, 4, 4, 1, 1)
        # 人员信息复选框动作
